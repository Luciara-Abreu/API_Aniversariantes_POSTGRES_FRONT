...
export class default1673556977460 implements MigrationInterface {
    name = 'default1673556977460'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "adms" ("id" SERIAL NOT NULL, "password" integer NOT NULL, "name" text NOT NULL, "birthDate" TIMESTAMP NOT NULL DEFAULT now(), "sexualOrientation" text NOT NULL, "email" text NOT NULL, "lastEmail" text NOT NULL, "fone" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d44a274a5cc87c565f3d4de3b79" PRIMARY KEY ("id"))`);

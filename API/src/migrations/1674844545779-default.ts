...
export class default1674844545779 implements MigrationInterface {
    name = 'default1674844545779'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" text NOT NULL, "birthDate" TIMESTAMP NOT NULL DEFAULT now(), "sexualOrientation" text NOT NULL, "email" text NOT NULL, "lastEmail" text NOT NULL, "fone" text NOT NULL, "avatar" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
